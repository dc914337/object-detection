...
try:
    ...
    print(f"=============== WARNING: Using very slow pytorch implementation because you couldn't compile cuda drivers ===============")
    print(f"=============== WARNING: Using very slow pytorch implementation because you couldn't compile cuda drivers ===============")
    print(f"=============== WARNING: Using very slow pytorch implementation because you couldn't compile cuda drivers ===============")
    ...
    class MSDeformAttnFunction:
        ...
        def apply(value, value_spatial_shapes, value_level_start_index, sampling_locations, attention_weights, im2col_step):
            ...
            output = (torch.stack(sampling_value_list, dim=-2).flatten(-2) * attention_weights).sum(-1).view(N_,
                                                                                                             M_ * D_,
                                                                                                             Lq_)
